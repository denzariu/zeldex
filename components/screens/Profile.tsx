...
const Profile = () => {
  ...
  return (
    <View style={styles.pageContainer}>
      ...
      <TouchableOpacity onPress={() => {navigation.navigate('ProfilePayment')}}>
        <Item title='Payment' icon={xmls.payment}/>
      </TouchableOpacity>

      <TouchableOpacity onPress={() => {navigation.navigate('ProfilePromoCodes')}}>
      ...
      <TouchableOpacity onPress={() => {navigation.navigate('ProfileHelp')}}>
...
const xmls = {
  ...
  profile: `<svg width="800px" height="800px" viewBox="0 -1 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g id="style=stroke">
  <g id="profile">
  ...
  help: `<svg fill="#000000" width="800px" height="800px" viewBox="0 -1 24 24" xmlns="http://www.w3.org/2000/svg">
